...
var productData = {
  ...
  p8: { name: 'Espresso Coffee Machine', img: '../assets/images/products/08-coffee-machine.png', desc: 'Multi-capsule compatible espresso machine. 19-bar pump, milk frother, dual-cup brewing.', specs: [['Pressure','19 Bar'],['Power','1300W'],['Water Tank','1.2L'],['Compatibility','Nespresso / Dolce Gusto / Ground'],['Material','ABS + Stainless Steel'],['Weight','3.2 kg']] },
  p9: { name: 'Upright Steam Mop', img: '../assets/images/products/09-steam-mop.png', desc: '1500W upright steam mop with 110°C steam and large 1.5L tank for whole-floor deep sanitizing.', specs: [['Power','1500W'],['Steam Temp','110°C'],['Water Tank','1.5L'],['Cord Length','7m'],['Steam Ready','25s'],['Weight','2.8 kg']] },
  p10: { name: 'Car Vacuum Cleaner Pro', img: '../assets/images/products/10-car-vacuum-pro.png', desc: 'High-power 12V car vacuum. 9000Pa suction, wet/dry dual-use, HEPA filter and LED work light.', specs: [['Voltage','12V DC'],['Suction','9000Pa'],['Power','120W'],['Filter','HEPA H13'],['Capacity','0.5L'],['Cord','5m'],['LED','Yes']] },
  p11: { name: 'Standing Garment Steamer', img: '../assets/images/products/11-garment-steamer.png', desc: '1800W rapid heat-up garment steamer. 30s ready, ceramic soleplate, 50 min continuous steam.', specs: [['Power','1800W'],['Steam Rate','35 g/min'],['Water Tank','1.8L'],['Ready Time','30s'],['Soleplate','Ceramic'],['Hanger','Telescopic'],['Continuous','50 min']] }
};
